...
Patches run_inference to use fast synthetic predictions (~50ms/image) instead of
...
\033[43m\033[30m   Predictions are synthetic (~50ms/image). No inference server  \033[0m
