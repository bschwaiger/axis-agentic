...
- First, write 2-3 sentences explaining your reasoning: what kind of model is being evaluated, \
what task it performs, and what the comparative findings suggest (e.g. which metrics are flagged, \
...
- Then propose exactly 3 PubMed search queries. STRICT RULES:
  ...
  - GOOD examples: "deep learning chest radiograph", "medical imaging benchmark", "MCC sensitivity classification"
  - BAD examples (DO NOT USE): "Effect of training set size on model performance", "deep learning for detecting abnormalities in radiographs"
