...
Useful for benchmarking AXIS or any custom model against a frontier
vision-language baseline (the same role Opus 4 plays in the manuscript).
...
SYSTEM_PROMPT = """\
You are an expert musculoskeletal radiologist. Analyze the X-ray image and \
determine whether it is normal or abnormal. Consider all musculoskeletal \
pathologies (fractures, hardware, degenerative changes, dislocations, \
